    ...
    internal unsafe static partial class RysRoot
    {
        ...
        internal static void CINTrys_roots(int nroots, double x, Span<double> u, Span<double> w)
        {
            ...
            switch (nroots)
            {
                ...
                case 6:
                case 7:
                    err = segment_solve(nroots, x, 0.0, u, w, 11, CINTrys_jacobi, CINTrys_schmidt);
                    break;
                case 8:
                    err = segment_solve(nroots, x, 0.0, u, w, 11, CINTrys_jacobi, CINTlrys_schmidt);
                    break;
                case 9:
                    err = segment_solve(nroots, x, 0.0, u, w, 10, CINTlrys_jacobi, CINTlrys_laguerre);
                    break;
                case 10:
                case 11:
                    err = segment_solve(nroots, x, 0.0, u, w, 18, CINTlrys_jacobi, CINTlrys_laguerre);
                    break;
                case 12:
                    err = segment_solve(nroots, x, 0.0, u, w, 22, CINTlrys_jacobi, CINTlrys_laguerre);
                    break;
                default:
                    err = segment_solve(nroots, x, 0.0, u, w, 50, CINTqrys_jacobi, CINTqrys_laguerre);
                    break;
            }
            if (err != 0)
            {
                Logger.Error("rys_roots fails: nroots=%d x=%g\n",
                        nroots, x);
#if ! KEEP_GOING
...
# if WITH_POLYNOMIAL_FIT
                ...
                case 6:
                    ...
                    break;
                case 7:
                    err = segment_solve1(nroots, x, lower, u, w, 0.5, 1.0, 60, CINTlrys_jacobi, CINTlrys_laguerre, CINTqrys_jacobi);
                    break;
                case 8:
                case 9:
                case 10:
                    //CINTqrys_jacobi(nroots, x, lower, u, w);
                    err = segment_solve1(nroots, x, lower, u, w, 0.15, 1.0, 60, CINTqrys_jacobi, CINTqrys_laguerre, CINTqrys_jacobi);
                    break;
                case 11:
                case 12:
                    err = segment_solve1(nroots, x, lower, u, w, 0.15, 1.0, 60, CINTqrys_jacobi, CINTqrys_laguerre, CINTqrys_jacobi);
                ...
                case 13:
                case 14:
                    err = segment_solve1(nroots, x, lower, u, w, 0.25, 1.0, 60, CINTqrys_jacobi, CINTqrys_laguerre, CINTqrys_jacobi);
                    break;
                case 15:
                case 16:
                ...
                case 24:
                    ...
                    break;
                default:
                    Logger.Error("libcint SR-rys_roots does not support nroots=%d\n", nroots);
                    break;
# if ! KEEP_GOING
            ...
            if (err != 0)
            {
                Logger.Error("sr_rys_roots fails: nroots=%d x=%.15g lower=%.15g\n",
                        nroots, x, lower);
#if ! KEEP_GOING
                System.Environment.Exit(err);
#endif
        ...
        internal static int rys_root1(double X, Span<double> roots, Span<double> weights)
        {
            ...
            if (X > 15.0)
            {
                ...
                F1 = (((1.9623264149430E-01 * Y - 4.9695241464490E-01) * Y -
                       6.0156581186481E-05) * E + Math.Sqrt(PIE4 / X) - E) * Y;
                F1 *= .5;
            }
            else if (X > 10.0)
            {
            ...
            else if (X > 5.0)
            {
                ...
                F1 = (((((((4.6897511375022E-01 * Y - 6.9955602298985E-01) * Y +
                       ...
                       3.1501078774085E-06) * E + Math.Sqrt(PIE4 / X) - E) * Y;
                F1 *= .5;
            }
            else if (X > 3.0)
            {
        ...
        internal static int rys_root2(double X, Span<double> roots, Span<double> weights)
        {
            ...
            else if (X < 10)
            {
                ...
                WW1 = ((((((4.6897511375022E-01 / X - 6.9955602298985E-01) / X +
                       ...
                       3.1501078774085E-06) * E + Math.Sqrt(PIE4 / X);
                F1 = (WW1 - E) / (X + X);
                Y = X - 7.5E+00;
            ...
            else if (X < 33)
            {
                ...
                WW1 = ((1.9623264149430E-01 / X - 4.9695241464490E-01) / X -
                       6.0156581186481E-05) * E + Math.Sqrt(PIE4 / X);
                F1 = (WW1 - E) / (X + X);
        ...
        internal static int rys_root4(double X, Span<double> roots, Span<double> weights)
        {
            ...
            else if (X <= 15)
            {
                ...
                WW1 = (((-1.8784686463512E-01 / X + 2.2991849164985E-01) / X -
                        4.9893752514047E-01) / X - 2.1916512131607E-05) * Math.Exp(-X) +
                        Math.Sqrt(PIE4 / X) - WW4 - WW3 - WW2;
            }
            else if (X <= 20)
            {
                WW1 = Math.Sqrt(PIE4 / X);
                ...
                WW1 = ((1.9623264149430E-01 / X - 4.9695241464490E-01) / X -
                       6.0156581186481E-05) * Math.Exp(-X) + WW1 - WW2 - WW3 - WW4;
            }
            else if (X <= 35)
            {
                WW1 = Math.Sqrt(PIE4 / X);
        ...
        internal static int R_dsmit(double* cs, double* fmt_ints, int n)
        {
            int i, j, k;
            double fac, dot, tmp;
            Span<double> v = stackalloc double[MXRYSROOTS];

            fac = -fmt_ints[1] / fmt_ints[0];
            tmp = fmt_ints[2] + fac * fmt_ints[1];
            if (tmp <= 0)
            {
                Logger.Error($"libcint::rys_roots negative value in Math.Sqrt for roots {n - 1} (j=1)");
                //SET_ZERO(cs, n, 1);
            ...
            tmp = 1 / Math.Sqrt(tmp);
            cs[0 + 0 * n] = 1 / Math.Sqrt(fmt_ints[0]);
            cs[0 + 1 * n] = fac * tmp;
            cs[1 + 1 * n] = tmp;
            ...
            for (j = 2; j < n; ++j)
            {
                ...
                if (fac <= 0)
                {
                    ...
                    Logger.Error($"libcint::rys_roots negative value in Math.Sqrt for roots {n - 1} (j={j})");
                    return j;
                }
                fac = 1 / Math.Sqrt(fac);
                cs[j + j * n] = fac;
                                  ...
                                  Span<double> roots, Span<double> weights)
        {
            ...
            double* rt = stackalloc double[MXRYSROOTS + MXRYSROOTS * MXRYSROOTS];
            ...
            error = FindRoots._CINT_polynomial_roots(rt, cs, nroots);
            if (error != 0)
            {
                return error;
            }
        ...
        internal static unsafe int CINTrys_schmidt(int nroots, double x, double lower, Span<double> roots, Span<double> weights)
        {
            ...
            if (lower == 0)
            {
                FMT.gamma_inc_like(fmt_ints, x, nroots * 2);
            }
            else
            {
                FMT.fmt_erfc_like(fmt_ints, x, lower, nroots * 2);
            }
        ...
        static quad c99_sqrtl(quad x)
        {
            quad z = quad.Sqrt(x);
            // ref. Babylonian method
            // http://en.wikipedia.org/wiki/Methods_of_computing_square_roots
            // An extra update should be enough due to the quadratic convergence
            return (z * z + x) / (z * quad.FromString("2"));
        }


        static int R_lsmit(quad* cs, quad* fmt_ints, int n)
        {
            int i, j, k;
            quad fac, dot, tmp;
            quad* v = stackalloc quad[MXRYSROOTS];

            fac = -fmt_ints[1] / fmt_ints[0];
            tmp = fmt_ints[2] + fac * fmt_ints[1];
            if (tmp <= quad.Zero)
            {
                Logger.Error("libcint::rys_roots negative value in sqrtl for roots %d (j=1)\n", n - 1);
                //SET_ZERO(cs, n, 1);
                for (k = 1; k < n; ++k)
                {
                    for (i = 0; i < n; ++i)
            ...
            tmp = 1 / quad.Sqrt(tmp);
            cs[0 + 0 * n] = 1 / quad.Sqrt(fmt_ints[0]);
            cs[0 + 1 * n] = fac * tmp;
            cs[1 + 1 * n] = tmp;
            ...
            for (j = 2; j < n; ++j)
            {
                ...
                if (fac <= quad.Zero)
                {
                    ...
                    Logger.Error("libcint::rys_roots negative value in sqrtl for roots %d (j=%d)\n", n - 1, j);
                    return j;
                }
                fac = 1 / quad.Sqrt(fac);
                cs[j + j * n] = fac;
        ...
        internal static unsafe int CINTlrys_schmidt(int nroots, double x, double lower, Span<double> roots, Span<double> weights)
        {
            ...
            int nroots1 = nroots + 1;
            quad* fmt_ints = stackalloc quad[MXRYSROOTS * 2 + MXRYSROOTS * MXRYSROOTS];
            quad* qcs = fmt_ints + nroots1 * 2;
            double* rt = stackalloc double[MXRYSROOTS + MXRYSROOTS * MXRYSROOTS];
            double* cs = rt + nroots;
            double* a;
            ...
            if (lower == 0)
            {
                FMT.lgamma_inc_like(fmt_ints, x, nroots * 2);
            }
            else
            {
                FMT.fmt_lerfc_like(fmt_ints, x, lower, nroots * 2);
            }

            if (fmt_ints[0] == quad.Zero)
            {
                for (k = 0; k < nroots; ++k)
                {
                    roots[k] = 0;
            ...
            if (nroots == 1)
            {
                rt[0] = (double)(fmt_ints[1] / fmt_ints[0]);
            }
            else
            {
                ...
                for (k = 1; k < nroots1; k++)
                {
                    for (i = 0; i <= k; i++)
                    {
                        cs[k * nroots1 + i] = (double)qcs[k * nroots1 + i];
                    }
                }
        ...
        internal static int R_qsmit(__float128* cs, __float128* fmt_ints, int n)
        {
            int i, j, k;
            __float128 fac, dot, tmp;
            __float128* v = stackalloc __float128[MXRYSROOTS];

            fac = -fmt_ints[1] / fmt_ints[0];
            tmp = fmt_ints[2] + fac * fmt_ints[1];
            if (tmp <= __float128.Zero)
            {
                Logger.Error("libcint::rys_roots negative value in __float128.Sqrt for roots %d (j=1)\n", n - 1);
                //SET_ZERO(cs, n, 1);
                for (k = 1; k < n; ++k)
                {
                    for (i = 0; i < n; ++i)
            ...
            tmp = __float128.One / __float128.Sqrt(tmp);
            cs[0 + 0 * n] = __float128.One / __float128.Sqrt(fmt_ints[0]);
            cs[0 + 1 * n] = fac * tmp;
            cs[1 + 1 * n] = tmp;
            ...
            for (j = 2; j < n; ++j)
            {
                ...
                if (fac <= __float128.Zero)
                {
                    ...
                    Logger.Error("libcint::rys_roots negative value in __float128.Sqrt for roots %d (j=%d)\n", n - 1, j);
                    return j;
                }
                fac = 1 / __float128.Sqrt(fac);
                cs[j + j * n] = fac;
                for (k = 0; k < j; ++k)
                {
                    cs[k + j * n] = fac * v[k];
        ...
        internal static int CINTqrys_schmidt(int nroots, double x, double lower, Span<double> roots, Span<double> weights)
        {
            int i, k, j, order, error;
            int nroots1 = nroots + 1;
            __float128* fmt_ints = stackalloc __float128[MXRYSROOTS * 2 + MXRYSROOTS * MXRYSROOTS];
            ...
            if (lower == 0)
            {
                FMT.qgamma_inc_like(fmt_ints, x, nroots * 2);
            }
            else
            {
                FMT.fmt_qerfc_like(fmt_ints, x, lower, nroots * 2);
            }
