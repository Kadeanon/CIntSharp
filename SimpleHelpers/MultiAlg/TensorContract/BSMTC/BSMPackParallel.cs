...
{
    internal partial struct BSMBlock
    {
        private struct PackParallel(in BSMBlock block, Memory<double> buffer) : IAction
        {
            ...
            #endregion Rows
            #region Cols
            readonly Memory<nint> colScatters = block.colScatters;
            ...
            internal readonly void Pack()
            {
                ...
                ParallelHelper.For(0, iBlockNum, in this, 4);
            }
